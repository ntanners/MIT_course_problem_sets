...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while True:    
        print "Current hand:", 
        display_hand(hand)        
        word = raw_input("Enter a word (or enter '.' to end your turn): ")
    
        # invalid word is rejected and a message is displayed asking the user to choose another word
        if word == '.': break        
...
def play_game(word_list):
    ...
    * If the user inputs anything else, ask them again.
    ...
    while True:
        choice = raw_input('Enter "n" for new game, "r" to repeat the last hand, and "e" to exit the game: ')
        if choice not in ('ren'):
